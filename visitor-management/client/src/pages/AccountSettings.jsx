  ...
  return (
    <div className="space-y-6">
      <div className="rounded-[32px] bg-white p-6 shadow-soft">
        <h2 className="text-xl font-semibold text-textPrimary">Account Settings</h2>
        <p className="mt-2 text-sm text-textSecondary">Update your profile details and password for this account.</p>

        <form onSubmit={handleProfileSubmit} className="mt-6 grid gap-6 md:grid-cols-2">
      ...
      <div className="rounded-[32px] bg-white p-6 shadow-soft">
        ...
        <form onSubmit={handlePasswordSubmit} className="mt-6 grid gap-6 md:grid-cols-2">
          <label className="block">
          ...
          <label className="block md:col-span-2">
            <span className="text-sm text-textSecondary">Confirm New Password</span>
            <input
